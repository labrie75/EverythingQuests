...
L["Auto-track accepted quests  |cffaaaaaa(matches Blizzard's default)|r"] = "Suivi automatique des quêtes acceptées  |cffaaaaaa(Par défaut de Blizzard)|r"
...
L["Show quest level prefix  |cffaaaaaa(e.g. [60] Title)|r"] = "Montrer le préfixe du niveau de quête  |cffaaaaaa(par exemple, [60] dans le titre)|r"
...
L["Show NEW tag on recently accepted quests  |cffaaaaaa(for about an hour after accepting)|r"] = "Affiche NEW sur les quêtes récemment acceptées  |cffaaaaaa(dure environ une heure)|r"
...
L["Auto-list current-zone world quests  |cffaaaaaa(lists every WQ in your zone without tracking each)|r"] = "Lister automatiquement les expéditions de la zone actuelle  |cffaaaaaa(Liste les expéditions de la zone sans les suivre)|r"
...
L["Other"] = "Autres"
L["World Quests"] = "Expéditions"
L["Enable World Quests map features  |cffaaaaaa(pins, summary, zone list)|r"] = "Activer les fonctionnalités pour les Expéditions  |cffaaaaaa(voir ci-dessous)|r"
