...
L["Nameplate Quest Icons"] = "Иконки заданий на индикаторах"
L["Left"] = "Слева"
L["Right"] = "Справа"
L["Above"] = "Сверху"
L["Below"] = "Снизу"
...
L["Draws a coloured gradient bar behind each section header (Quests, Campaign, World Quests, and so on), for a look closer to the default Blizzard tracker. Off by default."] = "Рисует цветную градиентную полосу за каждым заголовком раздела (Задания, Сюжет, Локальные задания и т.д.), чтобы вид был ближе к стандартному трекеру Blizzard. По умолчанию выкл."
