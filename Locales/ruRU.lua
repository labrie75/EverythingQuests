...
L["Show tracked / total on the Quests & Campaign headers"] = "Показывать отслеживаемые / всего в заголовках Заданий и Компаний"
...
L["Chain Guide (Storylines)"] = "Гид по цепочкам (Компания)"
...
L["Colors the section headers (Quests, Campaign, and so on) with the class color of the character you are currently logged in on. Overrides the color above while it is on. Off by default."] = "Окрашивает заголовки разделов (Задания, Компания и т.д.) в цвет класса персонажа, за которого вы сейчас играете. Пока включено, заменяет цвет выше. По умолчанию выкл."
